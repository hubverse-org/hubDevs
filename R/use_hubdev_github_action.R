...
#' [hubverse-org/hubverse-developer-actions](
#' https://github.com/hubverse-org/hubverse-developer-actions)
...
use_hubdev_github_action <- function(name) {
  url <- paste(
    "https://github.com/hubverse-org/hubverse-developer-actions/blob",
    "main",
    name,
    paste0(name, ".yaml"),
    sep = "/"
