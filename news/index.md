...
- [`use_hubdev_pkg_actions()`](https://hubverse-org.github.io/hubDevs/reference/use_hubdev_pkg_actions.md)
...
- Added functionality to
  [`use_hubdev_pkgdown()`](https://hubverse-org.github.io/hubDevs/reference/use_hubdev_pkgdown.md)
  to enable smooth transition of package docs to `hubStyle` theme.
- Added
  [`append_hubdev_readme_footer()`](https://hubverse-org.github.io/hubDevs/reference/append_hubdev_readme_footer.md)
