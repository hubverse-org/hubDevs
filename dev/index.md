...
and creates a `CODE_OF_CONDUCT.md` and `CONTRIBUTING.md` in the
`.github/` directory.
...
Code of
Conduct](https://hubverse-org.github.io/hubDevs/dev/CODE_OF_CONDUCT.md).
...
hubDevs
package](https://hubverse-org.github.io/hubDevs/dev/CONTRIBUTING.md).
