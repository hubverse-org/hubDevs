# Contributing to {{{ pkgname }}}

This outlines how to propose a change to `{{{ pkgname }}}`. 
For more general info about contributing to this, and other hubverse packages, please see the
[**hubverse contributing guide**]({{{ hubdocs_contribute_url }}}). 
...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("{{{ organisation }}}/{{{ pkgname }}}", fork = TRUE)`.
