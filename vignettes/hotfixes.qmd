...
gitGraph
    ...
    branch ak/create-funs/121
    branch ak/document-funs/121
    checkout main
    checkout ak/create-funs/121
    commit id: "ijkl"
    commit id: "mnop"
    checkout main
    merge ak/create-fun/121 id: "gpne"
    checkout ak/document-funs/121
    commit id: "qrst"
    commit id: "uvwx"
```
...
```sh
(ak/hotfix/123)$ git push -u origin ak/hotfix/123
```
