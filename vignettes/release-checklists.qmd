...
follow this protocol:
 ...
 - [ ] Create a new branch from the latest tag using `<author>/<hotfix>/<issue>`
   ...
   (detached-head)$ git switch -c znk/hotfix/143 # create a new branch
   (znk/hotfix/143)$
   ```
 - [ ] Write a test, fix the bug, commit, and push 
   ...
   ```
 - [ ] Create a pull request, get a review from another hubverse developer, and confirm that checks pass **(Do not merge yet)**
